    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 flex items-center justify-center p-8">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="grid grid-cols-2 gap-6">
          <Link href="/budget-dashboard/franchise" className="group bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all shadow-lg hover:shadow-xl">
          ...
          <Link href="/budget-dashboard/budget" className="group bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all shadow-lg hover:shadow-xl">
            <div className="text-3xl mb-3">💰</div>
